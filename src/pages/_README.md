...
- codes.astro：游戏兑换码页，显示 0 verified active codes、假码警报、warning-only 视频嵌入和验证渠道
...
- profit-calculator.astro：收益计算器页面，用于估算升级 ROI、目标时间、游玩时长收益、视频参考和公式边界
...
- evolution.astro：进化指南页，解释 42x speed、Fruit chain、重置损失、何时不要进化和重置层对比
